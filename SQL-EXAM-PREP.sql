...
SELECT
		...
		,DepartmentId
  FROM Volunteers
  ORDER BY [Name], AnimalId ASC, DepartmentId ASC
...
--11_	All Volunteers in a Department
GO
...
BEGIN
	...
	SET @countVolunteers = (
							SELECT
								COUNT(*) AS CountVolunteersByDepartment
							FROM Volunteers AS v
							JOIN VolunteersDepartments AS vd ON v.DepartmentId = vd.Id
